...
public enum ExtractConfiguration {
	...
	DONDORF_FRENCH(
			...
			1027, 615, 1, 5, 13, "A23456789TJQK", "DHSCB"),

	ISS_GERMAN("src/main/resources/org/jskat/samples/fixed/iss_german.svg",
			1027, 615, 2, 5, 13, "A23456789TJQK", "DHSCB"),
