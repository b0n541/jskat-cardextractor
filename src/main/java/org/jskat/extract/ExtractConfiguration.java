...
public enum ExtractConfiguration {
    ...
    ExtractConfiguration(final String location, final int width, final int height,
                         final String columnSymbols, final String rowSymbols, final int gap, final int targetHeight) {
