...
public enum ExtractConfiguration {
	...
	DONDORF_GERMAN(
			...
			1027, 615, 5, 13, "A23456789TJQK", "CDHSB", 246),
	...
	ExtractConfiguration(String location, int width, int height, int rows,
			int columns, String rowSymbols, String columnSymbols,
			int targetHeight) {
